...
const MindfulnessWeek4 = () => {
  ...
  useEffect(() => {
    const savedStatus = JSON.parse(localStorage.getItem('completedStatusWeek4'));
    if (savedStatus) {
  ...
  return (
    <>
      ...
      <Container className="mt-5">
        <h2 className="mb-4">Mindfulness Week 4</h2>
        <div className="mt-3">
          {[...Array(7)].map((_, index) => (
              ...
              <Card.Body>
                <form>
                  <div className="form-group">
                    <label>Tulis pengalaman meditasimu selama 4 minggu:</label>
        ...
        <Modal show={showCongratulationsModal} onHide={() => setShowCongratulationsModal(false)}>
          ...
          <Modal.Body>
            Selamat, Anda telah menyelesaikan intervensi selama 1 bulan. Klik tombol di bawah untuk melanjutkan ke tes SRQ.
          </Modal.Body>
          <Modal.Footer>
...
export default MindfulnessWeek4;
