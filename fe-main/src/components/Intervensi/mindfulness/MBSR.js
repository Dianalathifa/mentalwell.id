      ...
      <Container>
        <div className="container text-center" style={{ marginTop: "100px" }}>
          <h6 className="section-title mb-2" style={{ color: "#EBBCBC", fontWeight: "bold", fontSize: "35px" }}>
            <br />Selamat Datang di Minggu Pertama !<br />Yuk Kita Lakukan Latihan Meditasi<br />
          </h6>
        </div>
            ...
            <Card className="about-us-card" style={{ backgroundColor: "#EBBCBC", marginTop: "50px" }}>
              <Card.Body>
                ...
                <p style={{ fontSize: "16px" }}>
                  ...
                  1. &nbsp;Duduklah dengan nyaman di kursi atau di lantai dengan punggung tegak.<br></br>
                  2. &nbsp;Tutup mata Anda atau arahkan pandangan Anda ke bawah.<br></br>
                  3. &nbsp;Fokuskan perhatian Anda pada pernapasan Anda. Rasakan sensasi napas yang masuk dan keluar dari hidung Anda.<br></br>
                  4. &nbsp;Jika pikiran Anda mengembara, dengan lembut bawa kembali perhatian Anda ke pernapasan Anda.<br></br>
                  5. &nbsp;Ikuti alur meditasi dibawah.
                </p>
              </Card.Body>
            </Card>
          </Col>
          ...
          <Row>
            ...
            <Col md={5}>
              <h6 className="mb-4" style={{ marginLeft: "50px", marginTop: "50px" }}>
                "Ayo, mari kita praktikkan sekarang! Ikuti intervensi ini selama 7 hari. Setiap hari, praktikkan Meditasi Singkat dan centang pengalamanmu di daily checklist di bawah ini!"
              </h6>
