...
const MindfulnessWeek3 = () => {
  ...
  useEffect(() => {
    const savedStatus = JSON.parse(localStorage.getItem('completedStatusWeek3'));
    if (savedStatus) {
  ...
  return (
    <>
      ...
      <Container className="mt-5">
        <h2 className="mb-4">Mindfulness Week 3</h2>
        <div className="mt-3">
          {[...Array(7)].map((_, index) => (
              ...
              <Card.Body>
                <form>
                  <div className="form-group">
                    <label>Tulis pengalaman meditasimu selama 3 minggu:</label>
...
export default MindfulnessWeek3;
