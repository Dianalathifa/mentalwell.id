...
const SadPersonScaleDetail = () => {
  return (
    <div>
      <Navbar />
      <section id="suicide-sad-person-scale" className="section before-content" style={{ backgroundColor:"#C4EAF4", color: "#141313", fontFamily: "Abril Fatface", marginTop: "-140px", paddingTop: "200px" }}>
        <Col md={12} className="d-flex align-items-center justify-content-center">
          <div className="container text-left">
            <h6 className="section-title mb-2 tfonts">Kuisioner <br></br>Modified Sad Person Scale</h6>
            <h6 className="subtitle" style={{ fontSize: "28px" }}>
          ...
          <img src={suicide} alt="Sad Person Scale" style={{ width: "500px", height: "500px", maxWidth: "100%", maxHeight: "100%" }} />
        </Col>
      </section>
      <hr />
      ...
      <Container>
        <Col md={14} className="text-center">
          <Link to="/suicidetest-user">
            <Button variant="light" style={{ backgroundColor: "#00BCD4", borderColor: "#00BCD4", color: "white", fontWeight: "bold", fontSize: "20px" }}>Mulai Tes Suicide</Button>
          </Link>
        </Col>
      </Container>
      <hr />
