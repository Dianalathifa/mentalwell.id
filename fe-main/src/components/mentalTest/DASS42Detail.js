    ...
    return (
        <div>
                ...
                <Col md={14} className="d-flex align-items-center justify-content-center">
                    <div className="container text-left ">
                        ...
                        <h6 className="subtitle-dass" style={{ fontSize: "28px", marginLeft:"80px" }}>
                            ...
                            adalah kuesioner psikologi yang memetakan tiga faktor psikologis, 
                            yakni depresi, kecemasan, dan stress. Kuesioner ini terdiri atas 42 
                            pertanyaan yang pada website ini nantinya akan terpecah menjadi 14 soal 
                            dengan kategori soal yang telah disesuaikan serta telah diuji validitas dan reliabilitasnya</h6> <br></br><br></br><br></br>
                    </div>
                    <img src={DASS42} alt="Logo" style={{ borderRadius:"40px",marginRight:"80px", width: "430px", height: "400px", maxWidth: "100%", maxHeight: "100%" }} /> {/* Panggil gambar dengan variabel */}
                </Col>
            </section>
            <br/>
            <br/>
            <Container className="my-5">
                <Row className="justify-content-center">
                    <Col md={4} className="d-flex align-items-center justify-content-center">
                        <img src={detail1} alt="" style={{ borderRadius:"40px",width: "400px", height: "100%" }} /> {/* Panggil gambar dengan variabel */}
                    </Col>
                    <Col md={6}>
                        <p style={{ fontSize: "25px" }}>
                            <br/>Penggunaan DASS42 dapat digunakan dalam berbagai konteks, 
                            seperti dalam penelitian ilmiah, penilaian kesehatan mental dalam 
                            lingkungan kerja, evaluasi kesehatan mental sebelum pelayanan medis tertentu, dan sebagainya.<br></br><br></br></p>
                    </Col>        
                </Row>
            </Container>
            <br/>
            ...
            <Container className="my-5">
                <Row className="justify-content-center">
                    <Col md={4} className="d-flex align-items-center justify-content-center">
                        <img src={detail2} alt="" style={{ borderRadius:"40px",width: "400px", height: "100%" }} /> {/* Panggil gambar dengan variabel */}
                    </Col>
                    <Col md={6}>
                        <p style={{ fontSize: "25px" }}>
                            ...
                            tindakan lebih lanjut atau rujukan yang tepat.</p>
                    </Col>
                </Row>
            </Container>
            <Container className="my-5">
                <Col md={12}>
                    <p style={{ fontSize: "25px", textAlign: "justify", marginLeft:"60px"}}>
                        ...
                        <br></br>0:&nbsp;&nbsp;Tidak ada gejala
                        <br></br>1:&nbsp;&nbsp;Terkadang
                        <br></br>2:&nbsp;&nbsp;Sering
                        <br></br>3:&nbsp;&nbsp;Selalu
                        <br></br>Hasil akhir dari pengisian kuesioner DASS42 akan memberikan gambaran tentang tingkat depresi, kecemasan, dan stres yang dialami oleh responden.
                    </p>
                </Col>
            </Container>
