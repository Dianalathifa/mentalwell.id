...
const KuisionerPage = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Redirect ke halaman hasil klasifikasi
      ...
      <section id="psikolog-list" className="section before-content" style={{  color: "#141313", paddingTop: "100px" }}>
        ...
        <Row className="justify-content-center">
          <div className="container text-center">
            <h6 className="section-title mb-2 tfonts" style={{color:"#25B7D3", marginBottom:"20px"}}>Dass-42 Kecemasan </h6>
          </div>
          <Col md={10}>
          ...
          <div key={index} style={{ marginBottom: '20px' }}>
            ...
            <div>
              <Button
                ...
                style={{ marginLeft: '26px', borderRadius: '20px'  }}
              >
                Tidak Sesuai
              </Button>
              <Button
