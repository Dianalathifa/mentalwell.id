...
class DassStress extends BaseController
{
    ...
    public function saveAnswer()
    {
        ...
        if ($totalScore >= 0 && $totalScore <= 14) {
            $classification = 'Stress Normal';
        } elseif ($totalScore >= 15 && $totalScore <= 18) {
            $classification = 'Stress Ringan';
        } elseif ($totalScore >= 19 && $totalScore <= 25) {
            $classification = 'Stress Sedang';
        } elseif ($totalScore >= 26 && $totalScore <= 33) {
            $classification = 'Stress Parah';
        } else {
            $classification = 'Stress Sangat Parah';
        }
